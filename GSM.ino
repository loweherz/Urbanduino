...
void sendGSMData(char* path){
  ...
  GSM_Serial.print("T9,");
  GSM_Serial.print(cozir_sum);
  GSM_Serial.print(",");
  GSM_Serial.print(temp_sum);
  GSM_Serial.print(",");
  GSM_Serial.print(hum_sum);
  GSM_Serial.print(",");
  GSM_Serial.print(mic_sum);
  GSM_Serial.print(",");
  GSM_Serial.print(gprmc);
  GSM_Serial.println("\"");
  delay(2000); 
  ShowSerialData();
  showString(PSTR("\n"));
